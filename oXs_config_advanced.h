...
#define SENSITIVITY_MIN 50          // normal value for MS5611; for BMP, it is probably better to use a lower value like 20
...
#define RESISTOR_TO_GROUND  3.3 , 10    , 10  , 10 , 0  , 18               // set value to 0 when no divider is used for a voltage; can contains decimals 
#define RESISTOR_TO_VOLTAGE 27 , 73 , 110 , 27  , 0 , 47              // set value to 0 when no divider is used for a voltage; can contains decimals 
