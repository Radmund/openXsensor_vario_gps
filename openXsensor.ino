...
void setup(){
// set up the UART speed (38400 if GPS installed else 115200)  Raddy set 57600
#ifdef GPS_INSTALLED
  Serial.begin(57600); // when GPS is used, baudrate is reduced because main loop must have the time to read the received char.
#endif
#ifdef DEBUG 
